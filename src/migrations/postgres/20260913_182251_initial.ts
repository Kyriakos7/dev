...
export async function up({ db, payload, req }: MigrateUpArgs): Promise<void> {
  ...
  ALTER TABLE "menu_categories" ADD CONSTRAINT "menu_categories_section_id_menu_sections_id_fk" FOREIGN KEY ("section_id") REFERENCES "public"."menu_sections"("id") ON DELETE set null ON UPDATE no action;
  ...
  ALTER TABLE "menu_items_texts" ADD CONSTRAINT "menu_items_texts_parent_fk" FOREIGN KEY ("parent_id") REFERENCES "public"."menu_items"("id") ON DELETE cascade ON UPDATE no action;
  ...
  CREATE UNIQUE INDEX "venue_slug_idx" ON "venue" USING btree ("slug");
  CREATE INDEX "venue_updated_at_idx" ON "venue" USING btree ("updated_at");
  CREATE INDEX "venue_created_at_idx" ON "venue" USING btree ("created_at");
  CREATE UNIQUE INDEX "menu_sections_menurio_id_idx" ON "menu_sections" USING btree ("menurio_id");
  ...
  CREATE INDEX "menu_categories_section_idx" ON "menu_categories" USING btree ("section_id");
  CREATE UNIQUE INDEX "menu_categories_menurio_id_idx" ON "menu_categories" USING btree ("menurio_id");
  ...
  CREATE UNIQUE INDEX "menu_items_menurio_id_idx" ON "menu_items" USING btree ("menurio_id");
  ...
  CREATE INDEX "menu_items_texts_order_parent" ON "menu_items_texts" USING btree ("order","parent_id");
  ...
  CREATE INDEX "payload_locked_documents_rels_venue_id_idx" ON "payload_locked_documents_rels" USING btree ("venue_id");
...
export async function down({ db, payload, req }: MigrateDownArgs): Promise<void> {
  ...
  DROP TABLE "menu_items_texts" CASCADE;
